...
import static com.francesco.simpletodo.MainActivity.ITEM_POSITION;
import static com.francesco.simpletodo.MainActivity.ITEM_TEXT;
...
public class EditItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etItemText = (EditText) findViewById(R.id.etItemText); //referencing to the text in activity_edit_item
